...
<div class="table-responsive">
    <table class="table table-striped"> 
        ...
        <thead> 
            <tr> 
                <th colspan="6"><h4>PERSONAL DETAILS</h4></th> 
            ...
            <tr> 
                ...
                <td colspan="3"> 
                     @if ($employee->profile_image) 
                             <img src="{{public_path(config('app.file_path').'/'.$employee->profile_image)}}" alt="profile"
                ...
                <tr> 
                    <th colspan="6"><h4>LICENSE DETAILS</h4></th> 
                    <th></th><th></th><th></th><th></th><th></th>
                    <br><br> 
                </tr> 
                <tr> 
                ...
                <tr> 
                    <th colspan="6"><h4>EMPLOYER DETAILS</h4></th> 
                    <th></th><th></th><th></th><th></th><th></th>
                    <br><br> 
                </tr> 
            </thead>
